...
import {getAlreadySend, getAllProducts, getAllAlreadySend, getAllSystems} from './mock/process';
...
const proxy = {
  "GET /api/mydata": {
    ...
    "changeOrigin": true,
    "pathRewrite": { "^/api/mydata" : "/api/users" }
  },

  // 支持值为 Object 和 Array
  'GET /portal/api/user/currentUser.jhtml': {
    $desc: '获取当前用户接口',
    $params: {
      pageSize: {
        desc: '分页',
